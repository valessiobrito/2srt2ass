...
function getStyles($fontname, $fontsize, $topColor, $botColor, &$styles, &$keys)
{

	$specifics = array
		( 'Default' => array('PrimaryColour' => getColour('#FFFFFF') , "SecondaryColour" => getColour('#FFFFFF', null, 1.2), 'Alignment' => '2')
		, 'Top'     => array('PrimaryColour' => getColour($topColor) , "SecondaryColour" => getColour($topColor, null, 1.2), 'Alignment' => '8')
	...
	$defaults = array(
		...
		'OutlineColour' =>  getColour('#000000', 128),
		'BackColour' => getColour('#000000', 128),
		'Bold' => '-1',
		'Italic' => '0',
		'Underline' => '0',
		'StrikeOut' => '0',
