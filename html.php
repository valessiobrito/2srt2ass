...
<?php endif; ?>
			<div class="main-form">
				<form action="." method="post" enctype="multipart/form-data" name="form">
					...
					<div class="form-row">
						<span class="form-label">Top subtitle :</span>
						<span class="form-input"><input type="file" name="top" /></span>
					</div>
					
					<div class="form-row">
						<span class="form-label">Bottom subtitle :</span>
						<span class="form-input"><input type="file" name="bot" /></span>
					</div>
					...
					<div class="form-row">
						<span class="form-label">Font name :</span>
						<span class="form-input">
					...
					<div class="form-row">
						<span class="form-label">Top color :</span>
						<span class="form-input"><input type="text" name="topColor" class="color {hash:true}" />
					</div>
					
					<div class="form-row">
						<span class="form-label">Bottom color :</span>
						<span class="form-input"><input type="text" name="botColor" class="color {hash:true}" />
					</div>
